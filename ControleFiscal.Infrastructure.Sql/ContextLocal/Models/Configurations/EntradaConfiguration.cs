...
namespace ControleFiscal.Infrastructure.Sql.Focus.Configurations
{
    public partial class EntradaConfiguration : IEntityTypeConfiguration<Entrada>
    {
        public void Configure(EntityTypeBuilder<Entrada> entity)
        {
            ...
            entity.HasIndex(e => e.NotaFechada, "ENTRADA_IDX1");

            entity.HasIndex(e => e.CdFornecedor, "ENTRADA_IDX2");

            entity.HasIndex(e => e.DtEntrada, "ENTRADA_IDX3");

            entity.HasIndex(e => e.CdNota, "PK_ENTRADA")
                .IsUnique();
            ...
            entity.Property(e => e.Fechando)
                .HasColumnType("CHAR(1) ")
                .HasColumnName("FECHANDO");
            ...
            entity.Property(e => e.NumTerminalFechando).HasColumnName("NUM_TERMINAL_FECHANDO");
